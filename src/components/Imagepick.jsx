...
export default function Imagepick({ andle }) {
  ...
  return (
    ...
    {rl !== ''? <button onClick={handleClick} style={{border:"none", padding:"0.5rem 1.4rem",backgroundColor:"#dd3636", color:"white", borderRadius:"11px", cursor:"pointer", marginTop:"1rem"}}>x</button> : null}
