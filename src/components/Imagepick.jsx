...
export default function Imagepick() {
  ...
  return (
    <div style={{display:"flex", justifyContent:"center", alignItems:"center", flexDirection:"column", gap:"0.4rem", marginTop:"1rem"}}>
      <label htmlFor="img" style={{textAlign:'center', backgroundColor:"rgba(0,0,0, 0.5)", backdropFilter:"blur(5px)", padding:"0.3rem", color:"white", borderRadius:"11px", boxShadow:"1px 1px 11px rgba(0,0,0, 0.5)"}}>Seleccione una Image:</label>
